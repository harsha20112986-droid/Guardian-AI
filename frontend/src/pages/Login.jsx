      ...
      <div className="relative z-10 mx-auto grid w-full max-w-5xl items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="rounded-3xl border border-[#DDE8E2] bg-white p-6 shadow-[0_18px_50px_rgba(23,32,28,0.07)] md:p-8">
            ...
            <Link
              to="/signup"
              className="flex w-full items-center justify-center rounded-xl border border-[#D7E2DC] bg-[#F8FAF9] py-3 text-sm font-semibold text-[#52605A] transition-all hover:border-[#BFD9CB] hover:bg-emerald-50 hover:text-[#159A62]"
            >
              Create an account
            </Link>
